...
export function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-neutral-lightest border-b border-neutral-light">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              className="flex items-center gap-2 text-neutral-darker hover:text-neutral-charcoal transition-colors duration-300"
